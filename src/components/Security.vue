  ...
  <div v-bind:id="'page-' + page.idName" class="section page-intro">
    <div class="inner">
      <div class="page-info">
        ...
        <p class="page-label"><span>{{ $t(page.pageLabel.replace('applications', '')) }}</span></p> <!-- Security systems -->
      ...
      <a class="learn-more" v-on:click="$trackEvent('Learn More', 'click', page.idName)" :href="'https://aiot.innodisk.com/solution-smart-security/' + $t('common.param')" target="_blank">{{ $t('common.learn_more') }}</a>
    </div>
  </div>
</template>
