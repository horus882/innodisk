<template>
  <div v-bind:id="'page-' + page.idName" class="section page-intro">
    <div class="inner">
      ...
      <a class="learn-more" v-on:click="$trackEvent('Learn More', 'click', page.idName)" :href="'https://aiot.innodisk.com/solution-smart-automation/' + $t('common.param')" target="_blank">{{ $t('common.learn_more') }}</a>
    </div>
  </div>
</template>
